...
<section class="groups">
  ...
  <header class="topbar">
    <div class="tb-left">
      <img class="tb-icon" src="https://images.dz-crew.com/tablet/icons/group.png" alt="Groups" />
      <div class="tb-titles">
        <h2>Groups</h2>
        ...
        <div class="grid">
          ...
          {#each GroupList as g}
            <div class="card" on:click={() => requestJoin(g.id)} title={g.name}>
              <div class="avatar"><img src={g.image || 'https://images.dz-crew.com/tablet/groups/usericon.png'} alt="" /></div>
      ...
      <div class="panel">
        ...
        <div class="members">
          {#each GroupMembers as m, i}
            <div class="member">
              {#if m.isLeader}<span class="leader" title="Leader">★</span>{/if}
              <img class="m-img" src={m.avatar || './usericon.png'} alt="" />
